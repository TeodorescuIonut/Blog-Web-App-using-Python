...
class ContainerService:
    ...
    services_sqlalchemy = {
        ...
        IPassword: PasswordHashing(),
        IAuthentication: Authentication(SQLAlchemyUserRepo(SQLAlchemyDatabase(DatabaseConfig())),
        PasswordHashing()),
        IDatabaseUpgrade:DatabaseUpgradeandCreate(SQLAlchemyDatabase(DatabaseConfig()),
        DatabaseConfig()),
        IPagination:Paginate(),
